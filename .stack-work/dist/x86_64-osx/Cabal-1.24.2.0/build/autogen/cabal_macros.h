...
/* package Burn-0.1.0.0 */
#define VERSION_Burn "0.1.0.0"
#define MIN_VERSION_Burn(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Burn-0.1.0.0-7IS4CBqHvFj2pncH325bfV"

#define CURRENT_PACKAGE_KEY "Burn-0.1.0.0-7IS4CBqHvFj2pncH325bfV"
